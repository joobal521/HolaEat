                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" style="height: 50vh; overflow: unset;">
                        <div class="carousel-item active">
                            <img src="<c:url value='/resources/img/menu_main.jpg' />" class="d-block w-100" alt="...">
                        ...
                        <div class="carousel-item">
                            <img src="<c:url value='/resources/img/protein_main.jpg' />" class="d-block w-100" alt="...">
                        ...
                        <div class="carousel-item">
                            <img src="<c:url value='/resources/img/vegan_main.jpg' />" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>당신의 선택을 생각합니다.</h5>
                                <p>비건을 위한 식물성 식단</p>
                            </div>
...
<script src="<c:url value='/resources/js/rotate.js' />"></script>
</body>
